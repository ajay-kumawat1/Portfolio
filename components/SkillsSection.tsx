        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Building robust, scalable backend systems and APIs with modern
              technologies
            </p>
          </div>
        </div>
            ...
            >
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20 hover:border-white/40 transition-all duration-300 h-full">
                <div className="flex items-center mb-8">
                  <div
                    className={`w-16 h-16 rounded-xl bg-gradient-to-br ${category.gradient} flex items-center justify-center mr-4 shadow-lg`}
                  >
                ...
                <div className="grid grid-cols-2 gap-4">
                  {category.skills.map((skill, skillIndex) => (
                    ...
                    >
                      <div
                        className={`bg-white/5 hover:bg-white/10 rounded-xl p-4 border border-white/10 hover:border-white/20 transition-all duration-300 transform hover:scale-105 ${
                      ...
                      >
                        <div className="flex items-center justify-center mb-3">
                          <div className="w-8 h-8 flex items-center justify-center">
                            <i
                              className={`${skill.icon} text-xl text-gray-300 group-hover:text-white transition-colors`}
                            ></i>
                          </div>
                        </div>
