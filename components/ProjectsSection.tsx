...
export default function ProjectsSection() {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "Full-stack task management application with React frontend and Node.js backend, featuring real-time updates and team collaboration.",
      image: "https://readdy.ai/api/search-image?query=Task%20management%20application%20interface%2C%20project%20dashboard%2C%20team%20collaboration%20tools%2C%20kanban%20board%2C%20task%20tracking%20system%2C%20modern%20web%20application%2C%20productivity%20app%20design%2C%20clean%20interface%2C%20organized%20layout%2C%20professional%20dashboard%20design&width=800&height=600&seq=fullstack-project-004&orientation=landscape",
    ...
    },
    {
      ...
      description: "Distributed order processing system with event-driven architecture, saga pattern implementation, and comprehensive monitoring.",
      ...
      tech: ["Node.js", "RabbitMQ", "Docker", "Kubernetes", "MongoDB", "Prometheus"],
      category: "Backend",
  ...
  return (
    <section id="projects" className="py-24 bg-gradient-to-br from-slate-50 via-white to-purple-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Robust backend systems and APIs built with modern technologies and best practices
            </p>
          </div>
        </div>
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tech.map((tech, techIndex) => (
                        <span key={techIndex} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 text-xs px-3 py-1 rounded-full font-medium">
                          {tech}
                        </span>
                      ))}
                    </div>
        ...
        {/* Filter Navigation */}
        <div className={`flex justify-center mb-12 transition-all duration-1000 delay-800 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        ...
        <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-8">
          {filteredProjects.map((project, index) => (
            <div 
              key={project.id} 
              className={`group transition-all duration-1000 delay-${index * 100} ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
              onMouseEnter={() => setHoveredProject(project.id)}
              onMouseLeave={() => setHoveredProject(null)}
            >
                ...
                <div className="p-6">
                  ...
                  <div className="flex flex-wrap gap-2 mb-4">
                    {project.tech.slice(0, 3).map((tech, techIndex) => (
                      <span key={techIndex} className="bg-gradient-to-r from-blue-100 to-purple-100 text-blue-800 text-xs px-2 py-1 rounded-full">
                        {tech}
                      </span>
                    ))}
